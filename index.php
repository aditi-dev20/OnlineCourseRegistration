...
if(isset($_POST['submit']))
{
	...
	if($num>0)
	{
		...
		$_SESSION['errmsg']="Invalid Registration no or Password";
			...
			<div class="col-md-12">
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						...
						<li><a href="index.php">Student Area</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="content-wrapper">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h4 class="page-header">Please Login To Enter </h4>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="alert alert-info">
				<strong> Latest News / Updates / Notices</strong>
