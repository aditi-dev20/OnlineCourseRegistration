...
if (strlen($_SESSION['login']) == 0) {
  ...
  date_default_timezone_set('Asia/Delhi'); // change according timezone
  ...
  <body>
    ...
    <div class="content-wrapper">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-header">Student Pincode Verification</h1>
          </div>
        </div>
        <div class="row">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form name="pincodeverify" method="post">
                  ...
                  <button type="submit" name="submit" class="button">Verify</button>
                  <hr />
                </form>
              </div>
            </div>
